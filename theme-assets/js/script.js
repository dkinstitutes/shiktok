...
// Added ChatGPT Code to dwonlaod tiktok videos
...
async function downloadTikTokVideo(url) {
  ...
  const videoUrl = response.data.html;

  // Use axios to download the video and save it to a file
  ...
  const fileName = videoResponse.headers['content-disposition']
    .split(';')[1]
    .split('=')[1]
    .replace(/"/g, '');

  // Create a writable stream and pipe the video data to it
...
// Example usage:
downloadTikTokVideo('https://www.tiktok.com/@user/video/1234567890');
